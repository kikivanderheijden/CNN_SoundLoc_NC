...
# specify parameters
modelname   = 'CNN_con_K-32-64-64-128_KS-55-55-55-55_MP-12-22-22-32_DO-2-2-2-2-2_MSE'
...
model_l_conv1       = layers.Conv2D(32,(5,5),activation='relu', padding = 'same')(in1) # define first layer and input to the layer
...
model_r_conv1       = layers.Conv2D(32,(5,5),activation='relu', padding = 'same')(in2) # define first layer and input to the layer
...
model_final_conv1       = layers.Conv2D(64,(5,5),activation='relu', padding = 'same')(model_final_merge)
...
# CNN 3 - merged
model_final_conv2       = layers.Conv2D(64,(5,5), activation = 'relu', padding = 'same')(model_final_conv1_mp_do)
...
# CNN 4 - merged
model_final_conv3       = layers.Conv2D(128,(5,5), activation = 'relu', padding = 'same')(model_final_conv2_mp_do)
...
# compile
model.compile(loss = cust_mean_squared_error, optimizer = optimizers.Adam(), metrics=['cosine_proximity','mse', cos_distmet_2D_angular])
# print summary
model.summary()
# save
