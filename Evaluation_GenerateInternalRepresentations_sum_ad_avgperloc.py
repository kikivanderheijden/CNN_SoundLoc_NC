...
# save feature maps
np.save(dir_featuremaps+"/sum_ad_fmap_l2_1",fmap_l2_avg)
np.save(dir_featuremaps+"/sum_ad_fmap_l3_1",fmap_l3_avg)
np.save(dir_featuremaps+"/sum_ad_fmap_l9_1",fmap_l9_avg)
np.save(dir_featuremaps+"/sum_ad_fmap_l12_1",fmap_l12_avg)
np.save(dir_featuremaps+"/sum_ad_fmap_l15_1",fmap_l15_avg)
del fmap_l2_avg,fmap_l3_avg,fmap_l9_avg,fmap_l12_avg,fmap_l15_avg
print('model sum_ad done')
