...
# specify parameters
modelname   = 'CNN_con_K-32-64-128-128_KS-37-37-37-37_MP-12-22-22-32_DO-2-2-2-2-2_MSE'
...
model_final_conv1       = layers.Conv2D(64,(3,7),activation='relu', padding = 'same')(model_final_merge)
...
# CNN 3 - merged
model_final_conv2       = layers.Conv2D(128,(3,7), activation = 'relu', padding = 'same')(model_final_conv1_mp_do)
