...
# specify parameters
modelname   = 'CNN_con_K-32-64-128-128_KS-35-35-35-35_MP-12-22-22-32_DO-2-2-2-2-2_MSE'
...
model_final_conv1       = layers.Conv2D(64,(3,5),activation='relu', padding = 'same')(model_final_merge)
...
# CNN 3 - merged
model_final_conv2       = layers.Conv2D(128,(3,5), activation = 'relu', padding = 'same')(model_final_conv1_mp_do)
