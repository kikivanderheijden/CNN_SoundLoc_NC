...
# save feature maps
np.save(dir_featuremaps+"/con_mse_fmap_l2_1",fmap_l2_avg)
np.save(dir_featuremaps+"/con_mse_fmap_l3_1",fmap_l3_avg)
np.save(dir_featuremaps+"/con_mse_fmap_l9_1",fmap_l9_avg)
np.save(dir_featuremaps+"/con_mse_fmap_l12_1",fmap_l12_avg)
np.save(dir_featuremaps+"/con_mse_fmap_l15_1",fmap_l15_avg)
